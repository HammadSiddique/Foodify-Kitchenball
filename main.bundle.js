...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getComments\": () => (/* binding */ getComments)\n/* harmony export */ });\nconst invloveUrl = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/';\r\nconst appKey = 'TVh1v8c5aHUNyfocTFww';\r\n\r\nconst getComments = async(id) => {\r\n    const response = await fetch(`${invloveUrl}/apps/${appKey}/comments?item_id=52807`);\r\n    const data = await response.json();\r\n    return data.length > 0 ? data : [];\r\n};\r\n\r\n\r\n// let commetsList = [{\r\n//         title: 'Grilled Steak',\r\n//         name: 'Test',\r\n//         date: '2022-May-24',\r\n//         comment: 'It is great recipe'\r\n//     },\r\n//     {\r\n//         title: 'Grilled Steak',\r\n//         name: 'Test',\r\n//         date: '2022-May-24',\r\n//         img: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',\r\n//         comment: 'It is great recipe'\r\n//     },\r\n//     {\r\n//         title: 'Grilled Steak',\r\n//         name: 'Test',\r\n//         date: '2022-May-24',\r\n//         img: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',\r\n//         comment: 'It is great recipe'\r\n//     }\r\n// ];\r\n\r\n// let commentList = [];\r\n// const getComments = (id) => {\r\n//     const comments = document.querySelector('#commets-generator');\r\n//     comments.innerHTML = commentList.map((element, index) => {\r\n//         `<div class='comment-content ${index % 2 == 0? 'row-bg': ''}'>\r\n//                 <p>(${element.creation_date})</p>\r\n//                 <p>${element.username}:</p>\r\n//                 <p class='comment'>${element.comment}</p>\r\n//             </div>`\r\n//     }).join('');\r\n// }\r\n\r\n// const fetchComments = async() => {\r\n//     try {\r\n//         const data = await fetch(`${invloveUrl}/apps/${appKey}/comments?item_id=${id}`);\r\n//         const response = await data.json();\r\n\r\n//         response.result.map((elem) => commentList.push(elem));\r\n//         return getComments(52807);\r\n//     } catch (error) {\r\n//         return error;\r\n//     }\r\n// }\r\n\r\n\r\n// const getComments = (id) => {\r\n//     // const comments = document.querySelector('#commets-generator'); , { mode: 'no-cors' }\r\n//     fetch(`${invloveUrl}/apps/${appKey}/comments?item_id=${id}`)\r\n//         .then((response) => response.json())\r\n//         .then((item) => {\r\n//             item.forEach((element, index) => {\r\n//                 element.innerHTML = `<div class='comment-content ${index % 2 == 0? 'row-bg': ''}'>\r\n//                 <p>(${element.creation_date})</p>\r\n//                 <p>${element.username}:</p>\r\n//                 <p class='comment'>${element.comment}</p>\r\n//             </div>`\r\n//             }).join('')\r\n//         });\r\n// };\r\n\r\n// const comments = document.querySelector('#commets-generator');\r\n// const displayComments = () => {\r\n//     comments.innerHTML = commetsList.map((item, index) => `<div class='comment-content ${index % 2 == 0? 'row-bg': ''}'>        \r\n//             <p>(${item.date})</p>\r\n//             <p>${item.name}:</p>\r\n//             <p class='comment'>${item.comment}</p>\r\n//         </div>`).join('');\r\n// };\r\n\r\n\n\n//# sourceURL=webpack://foodify-kitchenball/./src/modules/comment.js?");
